 ...
 * @author Jeremy.CHAUT
 */
public class ManualProcess implements Runnable, Observer {
    ...
    public ManualProcess(BusyDialog d, M3UpgradModel m) {
        dial = d;
        model = m;
            ...
            try {
                ...
                if (m3Targ.isInitOK()) {
                    try {
                        ...
                        Logger.getLogger(ManualProcess.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
